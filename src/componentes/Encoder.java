...
public class Encoder {
	...
	private void codificar() {
		...
		long[] code;
		int cont = 1;
		Computador.tela.escreverNoConsole("$$$$ InstruÁ„o sendo codificada no encoder: ");
		while (instrucoes.size() != 0) {

			instrucaoAtual = instrucoes.get(0);

			if (cont == 1)
				Computador.tela.escreverNoConsole("$$$$ CodificaÁ„o para LONG das instruÁıes:");
	...
	public void mostrarInstrucoesCodificadas() {
		if (instrucoesCodificadas.size() == 0)
			Computador.tela.escreverNoConsole("$$$$ N„o h· instruÁıes codificadas no encoder.");
		else
			Computador.tela.escreverNoConsole("$$$$ InstruÁıes codificadas para LONG/INT/SHORT no encoder:");
	...
	public void mostrarInstrucoes() {
		if (instrucoes.size() == 0)
			Computador.tela.escreverNoConsole("$$$$ N„o h· instruÁıes no encoder.");
		else
			Computador.tela.escreverNoConsole("$$$$ InstruÁıes no encoder:");
	...
	public long[] encoderInstrucaoToLong(String instrucao) {
		...
		if (type1.matches() || type2.matches() || type3.matches()) {
			...
			if (type1.matches()) {
				...
				// System.out.println("Instru√ß√£oo codificada em longs: " +
				// code[0] + " " + code[1]);
			} else {
				String x, y, z;
				x = type3.group(2);
				...
				// System.out.println(
				// "Instru√ß√£o codificada em longs: " + code[0] + " " + code[1]
				// + " " + code[2] + " " + code[3]);
			}
